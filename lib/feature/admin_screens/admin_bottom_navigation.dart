...
import 'package:bodima/feature/admin_screens/boarders_details.dart';
...
class AdminBottomNavigation extends StatefulWidget {
  static const String routeName = '/adminbottomnavigation';
...
class _BottomNavigationState extends State<AdminBottomNavigation>
  ...
  final screenList = <Widget>[
    ...
    const AllBoardersListScreen(),
    const IndividualMSGScreen(),
    const BodersDetailsScreen(),
  ];
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            Navigator.pushNamed(context, AppRouter.sendMessageToAll);
          },
        ),
