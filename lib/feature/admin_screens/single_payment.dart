...
class SinglePaymentScreen extends StatefulWidget {
  static const String routeName = '/singlepaymentscreen';

  const SinglePaymentScreen({
    Key? key,
    required this.type,
  ...
  @override
  State<SinglePaymentScreen> createState() => _PaymentUploadScreenState();
}

class _PaymentUploadScreenState extends State<SinglePaymentScreen> {
